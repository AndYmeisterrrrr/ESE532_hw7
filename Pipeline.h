...
static void Filter_vertical_SW(const unsigned char * Input,unsigned char * Output);
static void Filter_vertical_HW(const unsigned char * Input,unsigned char * Output);
